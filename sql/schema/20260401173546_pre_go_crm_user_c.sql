...
CREATE TABLE IF NOT EXISTS `pre_go_crm_user_c` (
    `usr_id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Account ID',
    ...
    `usr_last_login_times`  int(11) NOT NULL DEFAULT 0 COMMENT 'Login Times',
    `usr_status` int(11) NOT NULL DEFAULT 0 COMMENT 'Status',
    PRIMARY KEY (`usr_id`),
